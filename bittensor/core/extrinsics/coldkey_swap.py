...
def announce_coldkey_swap_extrinsic(
    subtensor: "Subtensor",
    wallet: "Wallet",
    ...
    *,
    ...
    try:
        ...
        new_coldkey_hash = compute_coldkey_hash(new_keypair)
        ...
        call = SubtensorModule(subtensor).announce_coldkey_swap(
    ...
    try:
        ...
        if current_block < announcement.execution_block:
            ...
            if raise_error:
                raise error
            return ExtrinsicResponse(
                success=False, message=error_msg, extrinsic_receipt=None, error=error
            )
        ...
        call = SubtensorModule(subtensor).swap_coldkey_announced(
...
def remove_coldkey_swap_announcement_extrinsic(
    subtensor: "Subtensor",
    wallet: "Wallet",
    coldkey_ss58: str,
    *,
    ...
    try:
        ...
        call = SubtensorModule(subtensor).remove_coldkey_swap_announcement(
