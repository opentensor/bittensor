...
async def commit_sub_weights_extrinsic(
...
async def commit_timelocked_sub_weights_extrinsic(
    subtensor: "AsyncSubtensor",
    wallet: "Wallet",
    netuid: int,
    subuid: int,
...
async def reveal_sub_weights_extrinsic(
    subtensor: "AsyncSubtensor",
    wallet: "Wallet",
    netuid: int,
    subuid: int,
...
async def set_sub_weights_extrinsic(
    subtensor: "AsyncSubtensor",
    wallet: "Wallet",
    netuid: int,
    subuid: int,
