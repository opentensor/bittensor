"""Sync extrinsics for tempo-control operations (subnet owner and root sudo)."""
...
def root_set_activity_cutoff_factor_extrinsic(
    subtensor: "Subtensor",
    wallet: "Wallet",
    netuid: int,
    factor_milli: int,
    *,
    ...
    try:
        ...
        inner = SubtensorModule(subtensor).set_activity_cutoff_factor(
            netuid=netuid, factor_milli=factor_milli
        )
        call = Sudo(subtensor).sudo(call=inner)
...
def set_activity_cutoff_factor_extrinsic(
    subtensor: "Subtensor",
    wallet: "Wallet",
    netuid: int,
    factor_milli: int,
    *,
    ...
    try:
        ...
        call = SubtensorModule(subtensor).set_activity_cutoff_factor(
            netuid=netuid, factor_milli=factor_milli
        )
...
def set_tempo_extrinsic(
    ...
    *,
    ...
    try:
        ...
        call = SubtensorModule(subtensor).set_tempo(netuid=netuid, tempo=tempo)
...
def trigger_epoch_extrinsic(
    ...
    *,
    ...
    try:
        ...
        call = SubtensorModule(subtensor).trigger_epoch(netuid=netuid)
