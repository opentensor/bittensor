...
class server(torch.nn.Module):
    ...
    def config ():
        ...
        parser.add_argument('--neuron.local_train', action='store_true', help='''If true, allow local training. Only use this flag if setting to true.''', default=False)
        parser.add_argument('--neuron.remote_train', action='store_true', help='''If true, allow remote training. Only use this flag if setting to true.''', default=False)
