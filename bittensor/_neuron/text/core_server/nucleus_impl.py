...
class server(torch.nn.Module):
    ...
    def config ():
        ...
        parser.add_argument('--neuron.local_train', action='store_true', help='''Set this to true to enable local training. Only use this flag if setting to true.''', default=False)
        parser.add_argument('--neuron.remote_train', action='store_true', help='''Set this to true to enable remote training. Only use this flag if setting to true.''', default=False)
