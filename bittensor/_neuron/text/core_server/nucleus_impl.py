...
class server(torch.nn.Module):
    ...
    def config ():
        ...
        parser.add_argument('--neuron.local_train', action='store_true', help='''Include this flag to enable local training.''', default=False)
        parser.add_argument('--neuron.remote_train', action='store_true', help='''Include this flag to enable remote training.''', default=False)
