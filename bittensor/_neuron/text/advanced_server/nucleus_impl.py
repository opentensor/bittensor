...
class server(torch.nn.Module):
    ...
    def config ():
        ...
        parser.add_argument('--server.pretrained', action='store_false', type=bool, help='if the model should be pretrained',default=True)
        parser.add_argument('--server.padding', action='store_false', type=bool, help='To pad out final dimensions',default=True)
        ...
        parser.add_argument('--server.checking', action='store_false', type=bool, help='To check if server settings are correct',default=True)
