...
class Dataset:
    ...
    def __init__(self, 
        ...
        if run_generator:
            ...
            self.thread_manager = bittensor.thread_manager()
            # start the genrator
    ...
    def sample_generator(self, 
        ...
        for text_hash_batch in text_hash_batch_list:
            ...
            raw_text = list(map(lambda x: ' '.join(str(x).split()[:sequence_length]), raw_text))
