...
import bittensor 
import bittensor.metagraph as bittensor_metagraph
...
class Nucleus ():
        ...
        r""" Checks the passed config items for validity.
            Args:
                config (:obj:`munch.Munch, `required`): 
                    config to check.
        """
        bittensor_metagraph.Metagraph.check_config( config )

    def forward(self, synapse: synapse.Synapse, inputs: torch.Tensor, mode: bittensor.bittensor_pb2.Modality, priority: float) -> Tuple[torch.FloatTensor, str, int]:
        r""" Accepts a synapse object with inputs and priority, submits them to the forward work pool
            ...
            Args:
                ...
                mode (:enum:`bittensor.bittensor_pb2.Modality`, `required`):
            ...
            Returns:
                ...
                code: (:obj:`bittensor.bittensor_pb2.ReturnCode, `required`)
        ...
        try:
            ...
            code = bittensor.bittensor_pb2.ReturnCode.NucleusFull
            ...
            code = bittensor.bittensor_pb2.ReturnCode.UnknownException
            return None, message, code
        ...
        # Errors in the synapse call are caught in _backward and returned with the corresponding code.
            ...
            code = bittensor.bittensor_pb2.ReturnCode.NucleusTimeout
        return tensor, message, code

    def backward(self, synapse: synapse.Synapse, inputs_x: torch.Tensor, grads_dy: torch.FloatTensor, mode: bittensor.bittensor_pb2.Modality, priority: float) -> Tuple[torch.FloatTensor, str, int]:
    ...
    def _forward(self, call_params: List) -> Tuple[torch.FloatTensor, str, int]:
        r""" Actual processing function for the forward call. The passed synapse.call_forward must be thread safe.
            ...
            Args:
                call_params (:obj:`List[bittensor.synapse.synapse.Synapse, inputs, mode]`, `required`): 
        ...
        try:
            ...
            message = 'success'
            code = bittensor.bittensor_pb2.ReturnCode.Success
                
        except NotImplementedError:
            tensor = None
            message = 'modality not implemented'
            code = bittensor.bittensor_pb2.ReturnCode.NotImplemented
    ...
    def _backward(self, call_params: List):
        r""" Actual processing function for the backward call. The passed synapse.call_backward must be thread safe.
            ...
            Args:
                call_params (:obj:`List[bittensor.synapse.synapse.Synapse, inputs_x, grads_dy]`, `required`): 
