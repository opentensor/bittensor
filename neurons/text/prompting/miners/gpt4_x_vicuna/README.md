...
```
python3 -m pip install -r neurons/text/prompting/miners/gpt4_x_vicuna/requirements.txt
```
...
```
python3 neurons/text/prompting/miners/gpt4_x_vicuna/neuron.py --gpt4_x_vicuna.model_name GPT4_X_VICUNA.MODEL_NAME_OR_PATH
```
