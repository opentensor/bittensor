...
# Example Usage
```
python3 -m pip install -r neurons/text/prompting/miners/mosaic_insntruct/requirements.txt
python3 neurons/text/prompting/miners/mosaic_instruct/neuron.py
```
