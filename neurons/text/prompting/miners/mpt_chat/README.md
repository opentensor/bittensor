...
```
python3 -m pip install -r neurons/text/prompting/miners/mpt_chat/requirements.txt
```
...
```
python3 neurons/text/prompting/miners/mpt_chat/neuron.py --mpt_chat.model_name MPT_CHAT.MODEL_NAME_OR_PATH
```
