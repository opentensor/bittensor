...
## RoberMyers Miner
OpenAssistant's Pythia12B completion miner for bittensor's prompting network. 

# Example Usage
```
python3 -m pip install -r neurons/text/prompting/miners/oasst_pythia/requirements.txt
python3 neurons/text/prompting/miners/oasst_pythia/neuron.py
```
