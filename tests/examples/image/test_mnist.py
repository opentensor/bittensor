...
def test_run_mnist():
    ...
    mnist_session.neuron.metagraph.connect = MagicMock(return_value = (bittensor.Metagraph.ConnectSuccess, ""))    
    mnist_session.neuron.metagraph.subscribe = MagicMock(return_value = (bittensor.Metagraph.SubscribeSuccess, ""))   
