...
def test_run_gpt2_genesis():
    ...
    neuron = bittensor.proto.Neuron(
        ...
        public_key = gpt2_genesis_session.neuron.wallet.keypair.public_key,
    ...
    gpt2_genesis_session.neuron.metagraph.state.uid_for_pubkey[gpt2_genesis_session.neuron.wallet.keypair.public_key] = 0
