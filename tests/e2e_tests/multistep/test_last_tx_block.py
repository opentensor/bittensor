...
from ..utils import setup_wallet_with_path
...
def test_takes(local_chain):
    ...
    keypair, exec_command, wallet_path = setup_wallet_with_path("//Alice")
    ...
    keypair, exec_command, wallet_path = setup_wallet_with_path("//Bob")
    assert (
        local_chain.query(
