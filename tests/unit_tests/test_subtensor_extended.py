...
#     )
#
#     assert result == mocked_root_register_extrinsic.return_value
#
#
...
#
#     assert subtensor.set_delegate_take(
#         fake_wallet,
#         fake_wallet.hotkey.ss58_address,
#         0.18,
#     ).success
...
#
# def \
#         test_register(mock_substrate, subtensor, fake_wallet, mocker):
...
#     mocker.patch.object(
#         subtensor,
#         "get_neuron_for _pubkey_and_subnet",
#         return_value=NeuronInfo.get_null_neuron(),
#     )
#
...
#
#
# def test_transfer_stake(subtensor, mocker):
#     # Preps
#     wallet = mocker.Mock()
...
#     amount = mocker.Mock()
#
#     mocked_transfer_stake_extrinsic = mocker.patch.object(
#         subtensor_module, "transfer_stake_extrinsic"
#     )
#
#     # Call
#     response = subtensor.transfer_stake(
#         wallet=wallet,
...
#
#     # Asserts
#     assert response == mocked_transfer_stake_extrinsic.return_value
#
#     mocked_transfer_stake_extrinsic.assert_called_once_with(
#         subtensor=subtensor,
#         wallet=wallet,
#         destination_coldkey_ss58=destination_coldkey_ss58,
#         hotkey_ss58=hotkey_ss58,
