...
class TestSerialization(unittest.TestCase):
    ...
    def test_serialize(self):
        for _ in range(10):
            ...
            content = serializer.serialize(tensor_a, modality = bittensor.pb2.Modality.TENSOR, from_type = bittensor.pb2.TensorType.TORCH)
            tensor_b = serializer.deserialize(content, to_type = bittensor.pb2.TensorType.TORCH)
    ...
    def test_serialize_object_type_exception(self):
        ...
        with pytest.raises(serialization.SerializationTypeNotImplementedException):
            serializer.serialize(image, modality = bittensor.pb2.Modality.IMAGE, from_type = 11)

    def test_deserialization_object_type_exception(self):
        data = torch.rand([12, 23])
        
        serializer = serialization.get_serializer( serialzer_type = bittensor.pb2.Serializer.MSGPACK )
        tensor_message = serializer.serialize(data, modality = bittensor.pb2.Modality.TEXT, from_type = bittensor.pb2.TensorType.TORCH)
    ...
    def test_serialize_deserialize_image(self):
        ...
        serializer = serialization.get_serializer( serialzer_type = bittensor.pb2.Serializer.MSGPACK )
        serialized_image_tensor_message = serializer.serialize(image, modality = bittensor.pb2.Modality.IMAGE, from_type = bittensor.pb2.TensorType.TORCH)
        ...
        assert serialized_image_tensor_message.modality == bittensor.pb2.Modality.IMAGE
        assert serialized_image_tensor_message.dtype != bittensor.pb2.DataType.UNKNOWN

        deserialized_image_tensor_message = serializer.deserialize(serialized_image_tensor_message, to_type = bittensor.pb2.TensorType.TORCH)
        ...
        assert serialization_utils.torch_dtype_to_bittensor_dtype(deserialized_image_tensor_message.dtype) != bittensor.pb2.DataType.UNKNOWN
    ...
    def test_serialize_deserialize_text(self):
        ...
        serializer = serialization.get_serializer( serialzer_type = bittensor.pb2.Serializer.MSGPACK )
        serialized_data_tensor_message = serializer.serialize(data, modality = bittensor.pb2.Modality.TEXT, from_type = bittensor.pb2.TensorType.TORCH)
        ...
        assert serialized_data_tensor_message.modality == bittensor.pb2.Modality.TEXT
        assert serialized_data_tensor_message.dtype != bittensor.pb2.DataType.UNKNOWN

        deserialized_data_tensor_message = serializer.deserialize(serialized_data_tensor_message, to_type = bittensor.pb2.TensorType.TORCH)
        ...
        assert serialization_utils.torch_dtype_to_bittensor_dtype(deserialized_data_tensor_message.dtype) != bittensor.pb2.DataType.UNKNOWN
    ...
    def test_serialize_deserialize_tensor(self):
        ...
        serializer = serialization.get_serializer( serialzer_type = bittensor.pb2.Serializer.MSGPACK )
        serialized_tensor_message = serializer.serialize(data, modality = bittensor.pb2.Modality.TENSOR, from_type = bittensor.pb2.TensorType.TORCH)
       
        assert data.requires_grad == serialized_tensor_message.requires_grad
        assert list(data.shape) == serialized_tensor_message.shape
        assert serialized_tensor_message.modality == bittensor.pb2.Modality.TENSOR
        assert serialized_tensor_message.dtype == bittensor.pb2.DataType.FLOAT32

        deserialized_tensor_message = serializer.deserialize(serialized_tensor_message, to_type = bittensor.pb2.TensorType.TORCH)
        ...
        assert serialization_utils.torch_dtype_to_bittensor_dtype(deserialized_tensor_message.dtype) == bittensor.pb2.DataType.FLOAT32
