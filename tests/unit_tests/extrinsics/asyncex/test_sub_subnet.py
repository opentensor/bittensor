import pytest
from bittensor.core.extrinsics.asyncex import sub_subnet


@pytest.mark.asyncio
async def test_commit_sub_weights_extrinsic(mocker, subtensor, fake_wallet):
    ...
    # Call
    result = await sub_subnet.commit_sub_weights_extrinsic(
        subtensor=subtensor,
        wallet=fake_wallet,
        netuid=netuid,
        subuid=subuid,
...
@pytest.mark.asyncio
async def test_commit_timelocked_sub_weights_extrinsic(mocker, subtensor, fake_wallet):
    """Test successful `commit_sub_weights_extrinsic` extrinsic."""
    # Preps
    fake_wallet.hotkey.ss58_address = "hotkey"
    ...
    # Call
    result = await sub_subnet.commit_timelocked_sub_weights_extrinsic(
        subtensor=subtensor,
        wallet=fake_wallet,
        netuid=netuid,
        subuid=subuid,
...
@pytest.mark.asyncio
async def test_reveal_sub_weights_extrinsic(mocker, subtensor, fake_wallet):
    ...
    # Call
    result = await sub_subnet.reveal_sub_weights_extrinsic(
        subtensor=subtensor,
        wallet=fake_wallet,
        netuid=netuid,
        subuid=subuid,
...
@pytest.mark.asyncio
async def test_set_sub_weights_extrinsic(mocker, subtensor, fake_wallet):
    ...
    # Call
    result = await sub_subnet.set_sub_weights_extrinsic(
        subtensor=subtensor,
        wallet=fake_wallet,
        netuid=netuid,
        subuid=subuid,
