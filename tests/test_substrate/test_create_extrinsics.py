...
async def test_create_extrinsic_metadata_v14(kusama_substrate, keypair):
    ...
    extrinsic = await kusama_substrate.create_signed_extrinsic(call=call, keypair=keypair, tip=1)
...
async def test_create_batch_extrinsic(polkadot_substrate, keypair):
    ...
    extrinsic = await polkadot_substrate.create_signed_extrinsic(call=call, keypair=keypair, era={'period': 64})
