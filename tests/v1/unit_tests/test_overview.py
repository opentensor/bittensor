...
from bittensor.v1.commands.overview import OverviewCommand
from tests.v1.unit_tests.factories.neuron_factory import NeuronInfoLiteFactory
...
def test_get_total_balance(
    ...
    with patch(
        ...
        "bittensor.v1.commands.overview.get_coldkey_wallets_for_path",
        return_value=[mock_wallet] if config_all else [],
    ), patch(
        "bittensor.v1.commands.overview.get_all_wallets_for_path",
