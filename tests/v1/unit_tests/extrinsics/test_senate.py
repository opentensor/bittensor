...
from bittensor.v1 import subtensor, wallet
from bittensor.v1.extrinsics.senate import (
...
def test_register_senate_extrinsic(
    ...
    # Arrange
    with patch(
        "bittensor.v1.extrinsics.senate.Confirm.ask", return_value=not prompt
    ), patch("bittensor.v1.extrinsics.senate.time.sleep"), patch.object(
