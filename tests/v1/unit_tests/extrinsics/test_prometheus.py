...
from bittensor.v1.extrinsics.prometheus import prometheus_extrinsic


# Mocking the bittensor and networking modules
@pytest.fixture
def mock_bittensor():
    with patch("bittensor.v1.subtensor") as mock:
        yield mock


@pytest.fixture
def mock_wallet():
    with patch("bittensor.v1.wallet") as mock:
        yield mock


@pytest.fixture
def mock_net():
    with patch("bittensor.v1.utils.networking") as mock:
        yield mock
