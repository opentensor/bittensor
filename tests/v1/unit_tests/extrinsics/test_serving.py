...
from bittensor.v1.axon import axon as Axon
from bittensor.v1.extrinsics.serving import (
    serve_extrinsic,
    publish_metadata,
...
def test_serve_extrinsic_happy_path(
    ...
    with patch("bittensor.v1.extrinsics.serving.Confirm.ask", return_value=True):
        # Act
...
def test_serve_axon_extrinsic(
    ...
    # Arrange
    with patch(
        "bittensor.v1.utils.networking.get_external_ip",
