...
from bittensor.v1.utils.registration import LazyLoadedTorch
...
def mock_bittensor_logging(monkeypatch):
    ...
    monkeypatch.setattr("bittensor.v1.btlogging", mock_logger)
    return mock_logger
...
def test_lazy_loaded_torch__no_torch(monkeypatch, mock_bittensor_logging):
    monkeypatch.setattr("bittensor.v1.utils.registration._get_real_torch", lambda: None)
