...
from bittensor.v1.btlogging import LoggingMachine
from bittensor.v1.btlogging.defines import DEFAULT_LOG_FILE_NAME, BITTENSOR_LOGGER_NAME
from bittensor.v1.btlogging.loggingmachine import LoggingConfig
...
def test_state_transitions(logging_machine, mock_config):
    ...
    with patch("bittensor.v1.btlogging.loggingmachine.all_loggers") as mocked_all_loggers:
