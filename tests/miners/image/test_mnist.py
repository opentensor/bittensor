...
def test_run_mnist():
    ...
    mnist_miner_config.metagraph.chain_endpoint = 'feynman.akira.bittensor.com:9944'
    ...
    neuron = bittensor.proto.Neuron(
        ...
        public_key = mnist_miner.neuron.wallet.keypair.public_key,
    ...
    mnist_miner.neuron.metagraph.state.uid_for_pubkey[mnist_miner.neuron.wallet.keypair.public_key] = 0
