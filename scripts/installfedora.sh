...
linux_install_pre() {
    sudo dnf update 
    sudo dnf install -y apt-utils curl git cmake build-essential 
}
...
echo ""
echo "- 5) Run a miner: "
echo "    i.e. $ python ~/.bittensor/bittensor/miners/TEXT/gpt2_wiki.py --network \$NETWORK"        
echo ""
ohai "Extras:"
echo ""
echo "- Read the docs: "
