...
echo "NOTE: The Bittensor network is currently down for maintenance since block 1805945. Kusanagi is a test network to try your miner."
echo "Estimated mainnet re-launch: August 2021"
echo ""
ohai "Next steps:"
echo ""
echo "- 1) Choose your network: "
echo "    $ export NETWORK=kusanagi   # Test network (as of block 1805945)"
echo "    $ export NETWORK=exodus     # Main network (NOT OPEN: Coming in August) "
echo ""
echo ""
