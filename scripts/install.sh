...
echo ""
echo "- 5) Run a miner: "
echo "    i.e. python ~/.bittensor/bittensor/examples/TEXT/gpt2_wiki.py "        
echo ""
ohai "Extras:"
echo ""
echo "- Read the docs: "
