...
This file demonstrates how to train the Feed Forward NN on the network
without a training ste.

Example:
        $ python miners/IMAGE/run_skeleton.py

Look at the yaml config file to tweak the parameters of the model. To run with those 
default configurations, run:
        $ cd miners/IMAGE
        $ python run_skeleton/run_skeleton.py --session.config_file run_skeleton/run_skeleton_config.yaml
"""
import argparse
import os
import sys
